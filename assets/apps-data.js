(function () {
  ...
  function examApp(config) {
    ...
    const previewLabels = ["All exam domains", "Practice by topic", "Track your progress", "Review every explanation", "Strengthen weak areas", "Stay consistent"];
    return {
      ...config,
  ...
  window.MIRACLE_APPS = [
    {
      ...
      slug: "grammarify",
      group: "Everyday apps",
      name: "Grammarify - AI Keyboard",
      shortName: "Grammarify",
      subtitle: "Fix grammar, rewrite & translate as you type",
      category: "Productivity",
      eyebrow: "AI writing keyboard · iPhone & iPad",
      tagline: "Find the right words, right from your keyboard.",
      description: "Make everyday messages, work emails, and social captions easier to write. Correct grammar and spelling, adjust your tone, translate text, and get help from AI writing assistants directly in compatible apps on iPhone and iPad.",
      icon: "/grammarify/Grammarify_Appicon.png",
      colors: ["#7657ff", "#a344ef"],
      stores: ios("https://apps.apple.com/in/app/grammarify-ai-keyboard/id6769994469"),
      rating: 5.0,
      tags: ["Grammar correction", "Tone & rewrites", "AI assistants", "Translation"],
      features: [
        ["Grammar and spelling", "Review corrections to grammar, spelling, and punctuation before replacing your text."],
        ["Tone and rewrites", "Explore clearer wording and choose a tone that fits your message."],
        ["AI writing assistants", "Get help with replies, summaries, captions, and other everyday writing tasks."],
        ["Keyboard translation", "Translate text into your selected language while writing in compatible apps."],
        ["Custom assistants", "Save instructions for the writing tasks you repeat."],
        ["Personal keyboard themes", "Choose gradient themes, light or dark appearances, and typing preferences."],
      ],
      screenLabels: ["AI writing keyboard", "Change your tone", "Ask AI"],
      previewHeading: "A little help with everything you write.",
      previewDescription: "From a quick reply to a longer draft, correct your text, find the right tone, and translate without leaving the conversation.",
      appStoreScreenshots: [
        { src: "/grammarify/appstore-screenshots/01.webp", label: "Your AI writing keyboard" },
        { src: "/grammarify/appstore-screenshots/02.webp", label: "Rewrite in the right tone" },
        { src: "/grammarify/appstore-screenshots/03.webp", label: "Get help from AI assistants" },
        { src: "/grammarify/appstore-screenshots/04.webp", label: "Translate from your keyboard" },
        { src: "/grammarify/appstore-screenshots/05.webp", label: "Write in your favorite apps" },
      ],
    },
    {
      id: "fm_radio",
    ...
    },
    {
      ...
      subtitle: "Translate, create podcasts & work with files",
      category: "Productivity",
      eyebrow: "Language tools · iOS & Android",
      tagline: "Translate, create, and understand more.",
      description: "Translate text, photos, voice, and files—or turn text and audio into a podcast—through one clean workspace built for travel, learning, work, and everyday communication.",
      ...
      tags: ["Text translation", "Photo OCR", "Podcasts", "Voice"],
      features: [["Text translation", "Type or paste text and move between supported languages quickly."], ["Camera and photo translation", "Capture printed words or choose an image to extract and translate text."], ["Podcast creation", "Turn text or audio files into clear, shareable podcast audio."], ["Voice conversation", "Translate spoken phrases for more natural back-and-forth communication."], ["Translation history", "Return to useful translations without starting over."], ["Shareable results", "Copy, export, or share translated and generated content where you need it."]],
