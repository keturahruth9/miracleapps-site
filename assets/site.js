(function () {
  ...
  function renderProduct() {
    ...
    root.innerHTML = `
      ...
      <nav class="product-nav"><div class="product-shell nav-shell">${brandMarkup("/")}<div class="desktop-nav">${showDetailSections ? '<a href="#features">Features</a>' : ""}<a href="#previews">Screens</a>${showDetailSections ? '<a href="#privacy">Privacy</a>' : ""}<a class="nav-action" href="#download">Get the app</a></div><button class="menu-button" type="button" aria-expanded="false" aria-label="Open menu"><span></span><span></span></button></div></nav>
      <main id="main">
