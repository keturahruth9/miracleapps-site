(function () {
  ...
  function renderProduct() {
    ...
    root.innerHTML = `
      ...
      <footer class="site-footer product-footer"><div class="product-shell footer-grid"><div>${brandMarkup("/")}<a href="mailto:support@miracleapps.in">support@miracleapps.in</a></div><div><h2>Explore</h2><a href="/#apps">All apps</a><a href="/#principles">Our principles</a><a href="mailto:support@miracleapps.in">Support</a></div><div><h2>Legal</h2><a href="/${safe(app.slug)}/privacy/" target="_blank" rel="noopener noreferrer">App Privacy Policy ↗</a><a href="/${safe(app.slug)}/terms/" target="_blank" rel="noopener noreferrer">App Terms &amp; Conditions ↗</a><a href="/privacy/" target="_blank" rel="noopener noreferrer">Miracle Apps Privacy Policy ↗</a><a href="/terms/" target="_blank" rel="noopener noreferrer">Miracle Apps Terms &amp; Conditions ↗</a></div></div><div class="product-shell footer-base"><span>© 2026 Miracle Apps</span></div></footer>`;
  }
