(function () {
  ...
  function portfolioCard(app) {
    ...
    return `<article class="portfolio-card reveal" style="--card-accent:${app.colors[0]};--card-accent-2:${app.colors[1]}">
      ...
      <div class="portfolio-top"><img src="${safe(app.icon)}" alt="${safe(app.name)} icon" loading="lazy"><div class="portfolio-rating" aria-label="Rated ${rating} out of 5"><strong>${rating}</strong></div></div>
